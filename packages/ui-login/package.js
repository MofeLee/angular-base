...
Package.onUse(function(api) {
    ...
    options = {
        files: {
            ...
            client: [
                'assets/your_logo_here.gif',

                'lib/module.js',

                'views/login/login.import.styl',
                'views/login/login.ng.html',
                'views/login/login_controller.js',
...
Package.onTest(function(api) {
    api.use('tinytest');
    api.use('angular-base:ui-login');
    api.addFiles('ui-login-tests.js');
});
